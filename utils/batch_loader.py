...
class BatchLoader:
    def __init__(self, path='../../', custom_index = False, train_data_name = 'P_X_train_pos_text'):
        ...
        self.data_files = [path + 'vmware_data/{}'.format(train_data_name),
                           path + 'vmware_data/test.txt']
    ...
    def total_lines(self, target_str):
        return self.num_lines[0] if target_str=='train' else self.num_lines[1]
    ...
    def next_batch(self, batch_size, target_str, custom_indexes=[]):
